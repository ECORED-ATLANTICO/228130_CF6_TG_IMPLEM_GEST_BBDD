...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
          ...
          .col-lg-6.mb-4.mb-lg-0
            ...
            ul.lista-ul--color
              li.d-flex
                ...
                span Aditivas que pueden ser combinadas a lo largo de una dimensión. Ejemplo: ventas totales del producto, localización, y el tiempo.
              li.d-flex
                i.fas.fa-check.fa-xs
                span Semiaditivas que No pueden ser combinadas a lo largo de una o más dimensiones. Ejemplo: el resumen del inventario a través de productos, pero sumando los niveles de inventario a través del tiempo no tiene sentido.
              li.d-flex
                i.fas.fa-check.fa-xs
                span No Aditivas que No pueden ser combinadas a lo largo de cualquier dimensión.
          .col-lg-6
            figure
              img(src='@/assets/curso/temas/tema1/img1-5.png', alt='Medida')

    h3.titulo-tercero(data-aos="fade-right") Características del modelo multidimensional
        ...
        .row.justify-content-center.align-items-center
          .col-lg-6.mb-4.mb-lg-0
            ...
            ul.lista-ul--color
              li.d-flex
                i.fas.fa-check.fa-xs
                span <b>Expresividad</b>: deben tener los conceptos o bases necesarios para expresar claramente la realidad.
              li.d-flex
                i.fas.fa-check.fa-xs
                span <b>Simplicidad</b>: deben ser sencillos para que los esquemas o representaciones gráficas sean fáciles de entender.
              li.d-flex
                i.fas.fa-check.fa-xs
                span <b>Minimalidad</b>: cada concepto debe tener distinto significado.
              li.d-flex
                i.fas.fa-check.fa-xs
                span <b>Formalidad</b>: todos los conceptos.
          .col-lg-4
            figure
        ...
        .row.justify-content-center.align-items-center
          .col-lg-6.mb-4.mb-lg-0
            ...
            ul.lista-ul--color
              li
                i.fas.fa-check.fa-xs 
                span Tablas de hechos o <em>fact</em>
              li
                i.fas.fa-check.fa-xs 
                span Tablas de dimensiones o <em>lock up</em>
          .col-lg-4
            figure
        ...
        .row.justify-content-center.align-items-center
          ...
          .col-lg-4
            .titulo-sexto.color-acento-contenido.mb-3
              ...
              em Esquema estrella
            figure
              img(src='@/assets/curso/temas/tema1/img1-11.svg', alt='El esquema estrella se compone de:  dimensión tiempo, dimensión locación manufactura, dimensión producto, dimensión vendedor, dimensión cliente y dimensión ventas.')
        .row.justify-content-center.align-items-center
          .col-lg-6.mb-4.mb-lg-0
    ...
    h3.titulo-tercero(data-aos="fade-right") ¿Qué es un análisis multidimensional?
    ...
    h3.titulo-tercero(data-aos="fade-right") Operaciones OLAP

    .row.justify-content-center.align-items-center.mb-5
      .col-md-8.col-lg-2.mb-3.mb-lg-0(data-aos="fade-right")
        figure
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-6.col-md-4.col-lg-1.col-sm-2.mb-3.mb-lg-0
        figure
          img(src='@/assets/curso/temas/tema1/img1-19.svg', alt='Configuración')
      .col-lg-11.col-sm-10
        p.mb-0 La llegada de la "cuarta revolución industrial" o también llamada "industria 4.0", expresa que las fábricas u organizaciones inteligentes con tecnologías automatizadas deben agilizar los procesos utilizando el <em>big data</em> u otros avances digitales. Esta revolución, como las anteriores, cambia el mundo de las organizaciones y permite que las empresas que puedan entenderla generen más valor añadido y las que no, pueden verse destinadas a desaparecer, por no haber conseguido tanta eficiencia en el manejo de los recursos.
        ...
        .row.justify-content-center
          .col-md-10.mb-4.mb-md-0
            ...
            ul.lista-ul--color
              li.d-flex
                i.fas.fa-check.fa-xs
                span Volumen de los datos, (recopilación) debe ser capaz de analizar grandes volúmenes, para que la cantidad no sea un obstáculo, sino una ventaja.
              li.d-flex
                i.fas.fa-check.fa-xs
                span Variedad en el tipo de datos, conseguir que los datos pasen a ser datos estructurados para decidir cuáles pueden ser más útiles.
              li.d-flex
                i.fas.fa-check.fa-xs
                span Velocidad del análisis, en los tiempos por gestión.
        .row.justify-content-center
          .col-md-10.mb-4.mb-md-0
            figure.mb-5
            ...
            ul.lista-ul--color
              li.d-flex
                i.fas.fa-check.fa-xs
                span Gran rendimiento y la posibilidad de establecer relaciones complejas.
              li.d-flex
                i.fas.fa-check.fa-xs
                span Capacidad de trabajar con datos con un alto nivel de abstracción.
              li.d-flex
                i.fas.fa-check.fa-xs
                span Crean la posibilidad de numerosas relaciones entre diversos hechos y dimensiones.
              li.d-flex
                i.fas.fa-check.fa-xs
                span Poseen gran velocidad de procesamiento de información y restitución de los datos.
              li.d-flex
                i.fas.fa-check.fa-xs
                span Consiguen trabajar con datos previos almacenados en bases de datos relacionales simples.
        .row.justify-content-center
          .col-md-10.mb-4.mb-md-0
            figure.mb-5
    ...
    .row.justify-content-center.mb-5(data-aos="zoom-in")
      ...
      .col-lg-7
        LineaTiempoD.color-acento-botones
          ...
          div(numero="3" titulo="Ejemplo de <em>Data Warehouse</em>") 
            p Un ejemplo de empresa que usa bodegas de datos es <em>Whirlpool</em>. Esta fábrica de electrodomésticos ubicada en Michigan aplica su <em>data warehouse</em>:
            p.mb-0 Para hacer un seguimiento directo de sus casi 15 millones de clientes y de sus más de 20 millones de aparatos instalados. Las mayores aplicaciones del sistema son para marketing, ventas, mantenimiento, garantía y diseño de productos. Permite mantener stock de partes más ajustados y mejorar las condiciones de negociación con los proveedores de las mismas. Si, por ejemplo, un determinado motor se identifica como poseedor de una tasa de falla superior, Whirlpool puede utilizar la información para hacer renegociaciones de garantía con el proveedor. (XDOCS, s.f., p.2).
          p(numero="4" titulo="Otros ejemplos de <em>Data Warehouse</em>") Son las empresas de carga y pasajeros que también utilizan <em>data warehouses</em> para almacenar y acceder a gran cantidad de datos de sus operaciones y sistemas de reservas tales como, artículos, tiempos de entrega, equipamiento, capacidades, costos, ventas, márgenes, etc. Para identificar y programar actividades de <em>marketing</em>, planificación de capacidad, monitoreo de utilidades, proyecciones y análisis de ventas y costos, programas de calidad y servicio a sus clientes.
          p(numero="5" titulo="Empresas que usan <em>Data Warehouse</em>") En las grandes empresas que aplican <em>data warehouses</em>se encuentran: Amazon, Coca Cola, Google, Nike, Facebook, Procter & Gamble, Walmart, Tesla, Microsoft y Walt Disney.
